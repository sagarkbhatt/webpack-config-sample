...
function blank_theme_setup() {
	 ...
	 * to change 'blank_theme' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'blank_theme' ),
	) );
...
function blank_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'blank_theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'blank_theme' ),
...
function blank_theme_scripts() {
	wp_enqueue_style( 'blank_theme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'blank_theme-navigation', get_template_directory_uri() . '/dist/base.bundle.js', array(), '20151215', true );
